...
- `upload_scanning_antivirus` (String) Scan file uploads for viruses, trojans, ransomware, and other forms of malware. Options: `Block`, `Disable`, `Log`
- `upload_scanning_csam` (String) Scan file uploads for Child Sexual Abuse Material. Options: `Block`, `Disable`, `Log`
